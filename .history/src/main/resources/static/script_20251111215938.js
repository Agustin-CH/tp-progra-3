...
renderExampleSolutions();

function renderExampleSolutions() {
    // 5 soluciones de ejemplo de un tablero 5x5
    const exampleSolutions = [
        [[0,5,14,9,20],[13,8,19,4,15],[18,1,6,21,10],[7,12,23,16,3],[24,17,2,11,22]],
        [[0,5,10,17,20],[11,16,19,4,9],[6,1,14,21,18],[15,12,23,8,3],[24,7,2,13,22]],
        [[0,5,10,15,20],[11,14,19,4,9],[6,1,12,21,16],[13,18,23,8,3],[24,7,2,17,22]],
        [[0,5,16,11,20],[15,10,19,4,17],[6,1,8,21,12],[9,14,23,18,3],[24,7,2,13,22]],
    ...
    exampleSolutions.forEach((board, index) => {
